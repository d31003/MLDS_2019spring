...
class GAN(object):
    ...
    def train(self, X_train, epochs=6000, batch = 200):
        ...
        for cnt in range(epochs):#####
            ...
            if cnt%100==0:
                self.stacked_generator_discriminator.save('model/wgan_model_{}.h5'.format(cnt))
                self.G.save('model/wgan_{}.h5'.format(cnt))
