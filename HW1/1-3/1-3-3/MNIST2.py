...
####
Result=model.fit(train_array_normalize,train_label_array,epochs=10,batch_size=50,verbose=1,shuffle=True,validation_data=(test_array_normalize, test_label_array))
...
np.save("result_b50.npy",np.array([trainloss, trainacc, testloss, testacc]))####
model.save("MNIST_batch50.h5",model)####
