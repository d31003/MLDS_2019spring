...
def parse():
    ...
    parser.add_argument('--train_pg_improved', action='store_true', help='whether train policy gradient')
    parser.add_argument('--train_dqn', action='store_true', help='whether train DQN')
    parser.add_argument('--test_pg', action='store_true', help='whether test policy gradient')
    parser.add_argument('--test_pg_improved', action='store_true', help='whether test policy gradient')
